...
assert.ok(html.includes('app.js?v=20260827-3') && html.includes('consulting.js?v=20260828-2') && html.includes('consulting-engine.js?v=20260828-2') && html.includes('document-import.js?v=20260828-2') && html.includes('styles.css?v=20260828-2'), "厳格な自動計算判定・PDF候補選択・手動調整安全化の資産をキャッシュ更新する");
