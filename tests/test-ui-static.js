...
assert.ok(html.includes('src="media/web-sekisan-introduction.mp4" type="video/mp4"') && html.includes('poster="media/web-sekisan-introduction-thumbnail.jpg"'), "紹介MP4とサムネイルを結線する");
