window.CONSULTING_MASTER = {
  ...
  taskNames: {
    design: ["業務計画", "現地踏査", "設計計算", "設計図作成", "数量計算", "照査", "報告書作成", "打合せ", "任意作業"],
    planning: ["調査計画", "資料収集整理", "現地調査", "解析・検討", "計画立案", "照査", "報告書作成", "打合せ", "任意作業"],
    geologyAnalysis: ["既存資料整理", "地質解析", "地盤定数設定", "工法検討", "総合解析", "照査", "報告書作成", "打合せ", "任意作業"],
    geologyGeneral: ["機械ボーリング", "標準貫入試験", "サンプリング", "原位置試験", "現場管理", "コア整理", "任意作業"]
  },
  verifiedPresets: [
    {
      id: "design-note",
