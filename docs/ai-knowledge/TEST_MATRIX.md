...
| T-UI | `node tests/test-ui-static.js` | HTML要素の結線、4業務共通の上部5項目・業務基本情報7項目・追加／内訳／費用／集計カード、全業務の状態帯0件、見積提出先と基本情報のタブ間同期、数量制限、追加済み測量項目の変更、選択中測量項目の規定書PDF・原表ページ対応表、測量資料だけの年度一覧、5帳票、A4印刷CSS、Ez積算の統合案内・免責・公開HTTPS版Analytics常時計測 | `index.html`、`app.js`、`consulting.js`、`analytics.js`、`styles.css`変更時は必須 | 合格 |
