...
| 4業務タブ・設計地質積算 | T-CONSULT, T-CONSULT-UI, T-AERIAL-DETAIL, T-STANDARD-SCOPE, T-RATES, T-UI, T-ENGINE | 指定順、初期設計画面、設計／調査計画の分離、測量の作業規程分類、第2～5編の全件対応、別積算基準との非混在、年度切替、総合計、実ブラウザー表示 |
